...
const char* ssid = "brisa-255970"; //ssid do wifi
const char* password = "s6le9sww"; //senha do wifi
...
const char* PushBulletAPIKEY = "o.Z1Pt70TSTwpU5jF091Qc953kTsgnkXsg"; //chave do pushbullet
